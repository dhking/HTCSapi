...
namespace SignApplication
{
    ...
    {
        //破浪科技测试
        //        public static string ZQID = "ZQ2954800A7C3B47E683C1F283DDB157";
        ...
        public static string ZQID = ConfigurationManager.AppSettings["ZQID"];
        public static string PRIVATE_KEY = ConfigurationManager.AppSettings["PRIVATE_KEY"];
        public static string PUBLIC_KEY = ConfigurationManager.AppSettings["PUBLIC_KEY"];
        public static string URL = ConfigurationManager.AppSettings["SIGNURL"];
