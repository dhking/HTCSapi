  ...
  layui.use('table', function(){
    ...
    table.render({
      ...
      ,cols: [[
        ...
        , { field: 'keywords', title: '状态', minWidth: 300, templet: '<div><a href="https://www.baidu.com/s?wd={{ d.keywords }}" target="_blank" class="layui-table-link">{{ d.keywords }}</div>' }
        , { field: 'frequency', title: '到期时间', minWidth: 120, sort: true }
        , { field: 'userNums', title: '房间	' }
        , { field: 'userNums', title: '租客姓名' }
         , { field: 'userNums', title: '金额' }
        ,{ field: 'userNums', title: '操作',toolbar: '#barDemo'}
      ]]
      ,skin: 'line'
    });
