...
namespace Model
{
    ...
    public class PropertyModelBinderAttribute : Attribute
    {
        ...
        public System.Web.Mvc.IModelBinder GetBinder()
        {
    ...
    /// 将浏览器请求映射到数据对象。
    /// </summary>
    public class PropertyModelBinder : System.Web.Mvc.DefaultModelBinder
    {
        ...
        //    if (model is PagingModel) ((PagingModel)model).BindModel(controllerContext, bindingContext);
        //    return model;
        //}
        ...
        protected override object GetPropertyValue(ControllerContext controllerContext, System.Web.Mvc.ModelBindingContext bindingContext, System.ComponentModel.PropertyDescriptor propertyDescriptor, System.Web.Mvc.IModelBinder propertyBinder)
        {
        ...
        protected override void BindProperty(ControllerContext controllerContext, System.Web.Mvc.ModelBindingContext bindingContext, PropertyDescriptor propertyDescriptor)
        {
            ...
            System.Web.Mvc.IModelBinder propertyBinder = Binders.GetBinder(propertyDescriptor.PropertyType);
            object originalPropertyValue = propertyDescriptor.GetValue(bindingContext.Model);
            System.Web.Mvc.ModelMetadata propertyMetadata = bindingContext.PropertyMetadata[propertyDescriptor.Name];
            propertyMetadata.Model = originalPropertyValue;
            System.Web.Mvc.ModelBindingContext innerBindingContext = new System.Web.Mvc.ModelBindingContext()
            {
            ...
            // validation
            System.Web.Mvc.ModelState modelState = bindingContext.ModelState[fullPropertyKey];
            ...
            else
            {
                ...
                foreach (System.Web.Mvc.ModelError error in modelState.Errors.Where(err => String.IsNullOrEmpty(err.ErrorMessage) && err.Exception != null).ToList())
                {
        ...
        protected override void SetProperty(ControllerContext controllerContext, System.Web.Mvc.ModelBindingContext bindingContext, PropertyDescriptor propertyDescriptor, object value)
        {
            System.Web.Mvc.ModelMetadata propertyMetadata = bindingContext.PropertyMetadata[propertyDescriptor.Name];
            ...
            {
                System.Web.Mvc.ModelValidator requiredValidator = System.Web.Mvc.ModelValidatorProviders.Providers.GetValidators(propertyMetadata, controllerContext).Where(v => v.IsRequired).FirstOrDefault();
