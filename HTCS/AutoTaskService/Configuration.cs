...
namespace AutoTaskService
{
    public class Configuration
    {
        ...
        private const string DefaultServiceName = "HTCSAutoService";
        private const string DefaultServiceDisplayName = "飞鸟管家自动任务系统";
        private const string DefaultServiceDescription = "上海破浪信息科技有限公司";
        ...
        {
            configuration = (NameValueCollection)ConfigurationManager.GetSection("appSettings");
        }
