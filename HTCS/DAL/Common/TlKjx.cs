...
namespace DAL.Common
{
    public sealed class TlKjx
    {
        ...
        public string DoPost1(string url, string parameters)
        {
            HttpWebRequest req = GetWebRequest(url, "POST");
            req.ContentType = "application/x-www-form-urlencoded;charset=utf-8";
        ...
        public string DoPostJson(string url, object parameters)
        {
            JavaScriptSerializer serializer = new JavaScriptSerializer();
            string param = serializer.Serialize(parameters);
        ...
        public static string jsonc(object parameters)
        {
            JavaScriptSerializer serializer = new JavaScriptSerializer();
