...
(function($){
    ...
    BootstrapTable.prototype.Save = function () {
        //执行保存操作
        return this.enableAppend;
    };
    ...
    $.fn.bootstrapTable.methods.push('getColumns',
        'getModiDatas','removeRow','getColTotal','Save');
